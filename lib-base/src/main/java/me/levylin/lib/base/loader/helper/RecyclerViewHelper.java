...
public class RecyclerViewHelper implements IListViewHelper {
    ...
    //底部加载更多帮助类
    private IFooterViewHelper mFooterViewHelper;
    ...
    public RecyclerViewHelper(final RecyclerView recyclerView) {
        ...
        initFooterViewHelper();
    }

    /**
     * 初始化底部视图
     */
    private void initFooterViewHelper() {
     ...
     * 判断是否要显示没有更多
     */
    private boolean isNeedShowNoMore() {
